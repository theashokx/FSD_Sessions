...
//   });
// });
// app.patch("/users/:id", checkUserExists, (req, res) => {
//   users[req.userIndex] = { ...users[req.userIndex], ...req.body };
//   fs.writeFile("./User.json", JSON.stringify(users, null, 2), (err) => {
//     if (err) return res.status(500).json({ message: "Error updating user" });
//     res.json(users[req.userIndex]);
//   });
// });
// app.delete("/users/:id", checkUserExists, (req, res) => {
//   const deleted = users.splice(req.userIndex, 1);
//   fs.writeFile("./User.json", JSON.stringify(users, null, 2), (err) => {
//     if (err) return res.status(500).json({ message: "Error deleting user" });
//     res.json({ message: "Deleted successfully", user: deleted[0] });
//   });
// });
